...
package object client {
  ...
  case class Args(value: js.Dynamic) extends Named with Valued[js.Dynamic] {
    val name = "args"
  }

  sealed trait Arg extends Named
  case class BindingsArg(value: js.Dynamic) extends Arg with Valued[js.Dynamic] { val name = "bindings" }
  ...
  class UUID(val uuid: String) extends Named with Valued[String] with Product with Serializable {
    ...
    override def toString = s"${getClass.getSimpleName}${ScalaRunTime._toString(this)}"
